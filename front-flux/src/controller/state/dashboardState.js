...
class DashboardState extends BaseState {
  ...
  handleEvent(context, eventType, params = {}) {
    switch (eventType) {
      case EventType.SECOND_CLICK:
        context.switchState(StateType.SECOND, {
          path: NavigationPath.SECOND,
          params: params,
          topView: TopViewType.SECOND,
        });
        break;
      case EventType.COPY_CLICK:
        context.copy(params.text);
        break;
      default:
        break;
    }
